...
import {
	ActionRail,
	type ActionRailCause,
} from "@/components/article/action-rail";
			...
			>
				<div style={{ paddingTop: PROGRESS_CHROME_PX }}>
					...
					>
						...
						{/* Sticky sidebar: briefing + action rail */}
						<aside
							className={cn(
								"flex flex-col gap-5",
								"lg:sticky lg:self-start",
								"lg:top-33.5 lg:max-h-[calc(100vh-134px)] lg:overflow-y-auto lg:pb-10",
							)}
						>
							<ArticleBriefingSlot
