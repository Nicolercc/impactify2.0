	...
	return (
		<div ref={ref} className="relative mx-auto aspect-square w-full max-w-lg">
			...
			>
				...
				<p className="mt-2 font-serif text-sm font-medium text-ink">
					Op-ed: zoning reform
				</p>
				<p className="mt-1 line-clamp-2 text-xs text-ink-muted">
					Why rents keep climbing — and who profits.
				</p>
			</motion.div>
					...
					<ScrollReveal>
						<div className="flex flex-col gap-4 md:gap-6">
							<div className="flex flex-col gap-3">
								...
								<h2 className={titleClass}>
									...
									<UnderlineFlourish color="chartreuse">
										<em className="font-serif italic text-chartreuse-700">
											connected
										</em>
									</UnderlineFlourish>
									.
							...
							<div className="flex flex-col gap-3">
								...
								>
									Read a Times op-ed about housing. See the rally tonight. Check
									how your senator voted on the last housing bill. Donate to the
									community land trust fighting for affordable units.
								</p>
								<p
									className={cn(
								...
								>
									All from one page. Because democracy isn&apos;t separate from
									your feed.
								</p>
							</div>
							<ul className="space-y-3">
								{bullets.map((item) => (
									<li key={item} className="flex gap-3 text-body text-ink">
										<span
											className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-chartreuse-500"
											aria-hidden
										/>
										<span>{item}</span>
									</li>
